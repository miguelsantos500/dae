...
public class UserManager implements Serializable {
    ...
    public String redirect() {
        if (isUserInRole(UserGroup.GROUP.CCPUser)) {
            return "/faces/admin/admin_index?faces-redirect=true";
        }
        
        if (isUserInRole(UserGroup.GROUP.Student)) {
            return "/faces/student/student_index?faces-redirect=true";
        }
        
        if (isUserInRole(UserGroup.GROUP.Teacher)) {
            return "/faces/teacher/teacher_index?faces-redirect=true";
        }
        
        if (isUserInRole(UserGroup.GROUP.Institution)) {
            return "/faces/institution/institution_index?faces-redirect=true";
        }
